...
exports.UpdateStartMatch = exports.UpdateScoresOfMatches = exports.viewAllMatch = exports.CreateMatch = void 0;
    ...
    if (GetAdmin === null || GetAdmin === void 0 ? void 0 : GetAdmin.isAdmin) {
        if (CurrentMatch && CurrentMatch.startPlay) {
            if (CurrentMatch === null || CurrentMatch === void 0 ? void 0 : CurrentMatch.stopPlay) {
                ...
                const Matchscores = yield MatchModels_1.default.findByIdAndUpdate(req.params.matchID, {
                    teamAScore,
                    teamBScore,
                    scoreEntry: `${teamAScore} VS ${teamBScore}`,
                }, { new: true });
